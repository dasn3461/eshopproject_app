# Generated by Django 4.1.4 on 2023-02-22 14:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_status', models.CharField(choices=[('Order Received', 'Order Received'), ('Order Completed', 'Order Completed'), ('Order Canceled', 'Order Canceled'), ('Order Deleted', 'Order Deleted'), ('On The Way', 'On The Way')], max_length=100)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
